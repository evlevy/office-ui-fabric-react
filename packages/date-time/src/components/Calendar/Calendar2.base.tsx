...
import { CalendarMonthPicker } from './CalendarMonth/CalendarMonthPicker';
import { DateRangeType, DayOfWeek, FirstWeekOfYear } from '../../utilities/dateValues/DateValues';
import { defaultDateTimeFormatterCallbacks, defaultIconStrings, defaultWorkWeekDays, ICalendarState } from './Calendar.base';
import { ICalendar, ICalendarProps, ICalendarStyleProps, ICalendarStyles } from './Calendar.types';
import { ICalendarDay } from './CalendarDay/CalendarDay.types';
import { ICalendarMonthPicker } from './CalendarMonth/CalendarMonth.types';
import { IProcessedStyleSet } from '@uifabric/styling';

const getClassNames = classNamesFunction<ICalendarStyleProps, ICalendarStyles>();

export class Calendar2Base extends BaseComponent<ICalendarProps, ICalendarState> implements ICalendar {
  ...
  private _monthPicker = React.createRef<ICalendarMonthPicker>();
      ...
      <div className={css(rootClass, classes.root, className, 'ms-slideDownIn10')} onKeyDown={this._onDatePickerPopupKeyDown}>
        ...
        {isMonthPickerVisible ? (
          <div className={classes.monthPickerWrapper}>
            <CalendarMonthPicker
              {...calendarMonthPickerProps}
              navigatedItem={navigatedMonthDate}
              // navigatedDate={navigatedMonthDate!
              selectedItem={navigatedDayDate}
